...
--Service--
6)Service katmanı yazılır. ServiceBase içerisinde genel olarak kullanılacak olan metotlar generic(genel) şekilde yazılır.ICoreService interfaceten miras alınarak devam edilir.
